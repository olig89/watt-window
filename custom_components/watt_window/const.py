...
# Solar stays configured when this is off; Watt Windows are then worked out from grid prices only.
...
# Heat pump advice (boost / normal / hold back). Sensors only, off until switched on.
CONF_HP_ENABLED = "heat_pump_advice"
CONF_HP_POWER_W = "heat_pump_power_w"
CONF_HP_STORE_HOURS = "heat_pump_store_hours"
CONF_HP_MARGIN = "heat_pump_margin"  # per kWh, price currency
CONF_HP_MIN_MINUTES = "heat_pump_min_minutes"
...
DEFAULT_LOAD_W = 1000
DEFAULT_DAY_START = 8
DEFAULT_HP_POWER_W = 2000  # what the heat pump draws while running
DEFAULT_HP_STORE_HOURS = 4  # how long stored heat is useful (house or tank)
DEFAULT_HP_MARGIN = 0.02  # only shift for at least 2 c/kWh: covers the heat that leaks away
DEFAULT_HP_MIN_MINUTES = 60  # stay in a mode at least this long (compressor protection)
